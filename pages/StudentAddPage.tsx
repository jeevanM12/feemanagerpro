        ...
        <div className="bg-white p-8 rounded-xl shadow-lg max-w-2xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                    ...
                    <input type="text" id="rollNumber" value={rollNumber} onChange={(e) => setRollNumber(e.target.value)} className="shadow appearance-none border rounded w-full py-2 px-3 text-slate-700" required />
                </div>
                 <div>
                    <label className="block text-slate-600 text-sm font-bold mb-2" htmlFor="name">Full Name</label>
                    <input type="text" id="name" value={name} onChange={(e) => setName(e.target.value)} className="shadow appearance-none border rounded w-full py-2 px-3 text-slate-700" required />
                </div>
                 <div>
                    <label className="block text-slate-600 text-sm font-bold mb-2" htmlFor="class">Class</label>
                    <input type="text" id="class" value={className} onChange={(e) => setClassName(e.target.value)} className="shadow appearance-none border rounded w-full py-2 px-3 text-slate-700" required />
                </div>
                 <div>
                    <label className="block text-slate-600 text-sm font-bold mb-2" htmlFor="grade">Grade</label>
                    <input type="text" id="grade" value={grade} onChange={(e) => setGrade(e.target.value)} className="shadow appearance-none border rounded w-full py-2 px-3 text-slate-700" required />
                </div>
                 <div>
                    <label className="block text-slate-600 text-sm font-bold mb-2" htmlFor="totalFees">Total Fees (INR)</label>
                    <input type="number" id="totalFees" value={totalFees} onChange={(e) => setTotalFees(e.target.value)} className="shadow appearance-none border rounded w-full py-2 px-3 text-slate-700" required min="1" />
                </div>
