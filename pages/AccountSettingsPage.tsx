            ...
            <form onSubmit={handlePasswordChange} className="space-y-6">
                ...
                <div className="flex justify-end">
                    <button 
                        type="submit"
                        disabled={isLoading}
                        className="bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-300 text-white font-bold py-3 px-6 rounded-lg focus:outline-none focus:shadow-outline w-full sm:w-auto transform transition duration-150 hover:scale-105"
                    >
