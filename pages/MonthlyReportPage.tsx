  ...
  return (
    <div className="container mx-auto p-4 sm:p-6 lg:p-8 text-center">
       <div className="bg-white p-12 rounded-xl shadow-lg inline-block">
        ...
        <h1 className="text-4xl font-extrabold text-slate-800">Monthly Reports</h1>
        <p className="text-xl text-slate-600 mt-4">This feature is currently under construction.</p>
        <p className="text-slate-500 mt-2">Our team is working hard to bring you detailed monthly financial summaries.</p>
